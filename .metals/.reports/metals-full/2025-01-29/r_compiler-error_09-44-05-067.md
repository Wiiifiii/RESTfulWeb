...
public class ImagesWebController {
    ...
    /**
     * Show table of active images, possibly filtered by ID, owner, contentType.
     */
    @GetMapping
    public String listImages(
        ...
        try {
            ...
            // Some possible contentTypes for the filter dropdown
    ...
    /**
     * View the trash, possibly with filters.
     */
    @GetMapping("/trash")
    ...
    public String editImageForm(
        ...
        try {
            ...
            // preserve filters in hidden fields, so we can redirect back with them
            model.addAttribute("idFilter", idFilter);
            model.addAttribute("ownerFilter", ownerFilter);
            model.addAttribute("contentTypeFilter", contentTypeFilter);
    ...
    /**
     * Save (create or update) an image. Handle file upload if present.
     * Also preserve filter params in redirect.
     */
    @PostMapping("/save")
